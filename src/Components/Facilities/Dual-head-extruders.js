...
//           <h2>Dual Head Extruder Overview:</h2>
//           <ul>
//             <li>
...
//         <h4>Applications of Dual Head Extruders:</h4>
...
const Facility2 = () => {
  ...
  return (
    <div className="facility-container2">
      <div className="facility-header2">
        <h1>Dual Head Extruders for Multi-Layer Extrusion</h1>
      </div>
      ...
      <div className="facility-paragraph2">
        ...
        <div className="facility-image2" onClick={() => openModal(Dualhead)}>
          <img src={Dualhead} alt="Dual Head Extruder" />
        </div>
      </div>
