...
// // State for managing the modal and full-screen image
...
//         {/* Left Side Image */}
//         <div className="facility-image "onClick={() => openModal(HotFeed)}>
...
//        {/* Left Side Image */}
//        <div className="facility-image" onClick={() => openModal(ColdFeed)}>
...
// <div className="facility-content">
//         {/* Left Side Image */}
//         <div className="facility-image" onClick={() => openModal(CoExtrusion)}>
          ...
          <div className="facility-info">
            <div className="facility-info-left">
              ...
              <div className="info-box">
                <h4>Functionality:</h4>
                <ul>
                  <li><b>Pre-Heated Input:</b> Rubber compound is pre-heated and softened before entering the extruder.</li>
                  <li><b>Screw and Barrel:</b> A screw inside a heated barrel pushes the rubber through a die, forming continuous shapes like hoses, sheets, or tire treads.</li>
                  <li><b>Efficiency:</b> Suitable for simpler profiles and works with preheated materials from earlier processing steps, reducing energy costs.</li>
                </ul>
              </div>
            </div>
            <div className="facility-info-right">
              ...
              <div className="info-box"><h4>Advantages:</h4>
                <ul>
                  <li><b>Cost-Effective</b>: Optimized for continuous production of large volumes.</li>
                  <li><b>Energy Savings:</b> Requires less mechanical force due to pre-heated rubber.</li>
                  <li><b>Tire Industry:</b> Commonly used in tire production facilities for uniform output.</li>
                </ul>
              </div>
            </div>
            ...
            <div className="facility-info">
              <div className="facility-info-left">
                ...
                <div className="info-box">
                  <h4>Functionality:</h4>
                  <ul>
                    <li><b>Room Temperature Input:</b> Rubber is fed into the extruder at room temperature, with mechanical energy driving the extrusion process.</li>
                    <li><b>Gradual Heating:</b> The screw compresses and heats the rubber gradually, plasticizing it before it exits through the die.</li>
                    <li><b>Energy Efficiency:</b> Eliminates the need for pre-heating, making it suitable for continuous processing of diverse rubber compounds.</li>
                  </ul>
                </div>
              </div>
              <div className="facility-info-right">
                <div className="info-box">
                  <h4>Advantages:</h4>
                  <ul>
                    <li><b>Flexibility:</b> Capable of handling different materials and complex shapes.</li>
                    <li><b>Energy Efficient:</b> More efficient than hot feed extruders, as no external pre-heating is needed.</li>
                    <li><b>Temperature Control:</b> Better control over temperature, reducing scorching and improving quality.</li>
                    <li><b>Reduced Downtime:</b> Faster product changes without the need for pre-heating.</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <div className="facility-right">
          ...
          <div className="facility-info">
            <div className="facility-info-left">
              <div className="info-box">
                <h4>Application:</h4>
                <p><b>Purpose:</b> Simultaneously extrudes multiple layers of rubber or different materials to create complex profiles with varying properties in different sections.</p>
              </div>
              <div className="info-box">
                <h4>Functionality:</h4>
                <ul>
                  ...
                  <li><b>Combination:</b> Allows integration of different rubber compounds or materials like plastic or metal into one profile.</li>
                </ul>
              </div>
            </div>
            <div className="facility-info-right">
              <div className="info-box">
                <ul>
                  <li><b>Products:</b> Used for seals, hoses, tires, gaskets, and complex automotive parts with multi-layer or multi-material requirements.</li>
                  <li><b>Varied Properties:</b> Ideal for products needing distinct sections, such as a soft inner layer and hard outer layer.</li>
                </ul>
              </div>
              <div className="info-box"><h4>Advantages:</h4>
                <ul>
